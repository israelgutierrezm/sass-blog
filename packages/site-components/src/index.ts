...
export { default as CollectionGridSection } from './components/CollectionGrid.vue'
export { componentFor, isDynamicType } from './registry'
export type { ResolvedSections } from './types'
