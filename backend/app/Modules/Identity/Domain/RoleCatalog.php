...
final class RoleCatalog
{
    ...
    public const ROLES = [
        ...
        'editor' => ['workspace.view', 'site.view', 'site.create', 'site.update', 'page.view', 'page.create', 'page.update', 'category.manage', 'author.manage', 'collection.view', 'entry.view', 'entry.create', 'entry.update', 'media.view', 'media.manage', 'menu.manage', 'analytics.view', 'newsletter.manage'],
